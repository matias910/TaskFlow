...
function SideBar({ theme, user, show}) {
    const menuItems = [
    ...
    return (
        <aside
            className={`h-100% shrink-0 overflow-hidden transition-all duration-700 ease-in-out flex flex-col gap-30 border-r-1 border-gray-400
